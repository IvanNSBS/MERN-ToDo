...
todoRoutes.route('/:id').get(function(req, res) {
    ...
    Todo.findById(id, function(err, todo) { res.json(todo); });
});
...
todoRoutes.route('/update_description/:id').post(function(req, res) 
{
...
todoRoutes.route('/update_completed/:id').post(function(req, res) 
{
    Todo.findById(req.params.id, function(err, todo) {
        if (!todo)
        {
